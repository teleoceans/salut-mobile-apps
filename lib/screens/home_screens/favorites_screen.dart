...
import 'package:salute/components/shopping_components/favorites_list_view.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Padding(
        ...
        child: Provider.of<FavoritesProvider>(context).favoriteFood.isEmpty
            ? Column(
            ...
            : ListView(
                children: [
                  FavoritesListView(
                    favoritesFood:
                        Provider.of<FavoritesProvider>(context).favoriteFood,
                  ),
                  Container(
                  ...
                  SizedBox(
                    height: 420,
                    child: FoodGridView(
                        food: Provider.of<FavoritesProvider>(context)
                            .favoriteFood),
                  ),
                ],
              ),
